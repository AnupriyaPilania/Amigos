...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="background-color:#b30000;">
	<div class="container" style="padding-top: 10px; padding-bottom: 10px;">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index" style="margin-top: -10px;"><img
				...
				style="font-size: xx-large; line-height: 60px;color:white;">AMIGOS</span>
		</div>
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a href="allusers"><img
								src="${pageContext.request.contextPath}/resources/images/27.png"
								alt="logo" width="20" height="20">&nbsp <b>Peoples</b></a></li>
						<li><a href="friends"><img
								src="${pageContext.request.contextPath}/resources/images/29.jpg"
								alt="logo" width="20" height="20">&nbsp <b>Friends</b></a></li>
						<li><a href="talk"><img
								src="${pageContext.request.contextPath}/resources/images/30.png"
